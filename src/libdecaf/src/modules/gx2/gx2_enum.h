...
ENUM_BEG(GX2SamplerVarType, uint32_t)
   ...
   ENUM_VALUE(Sampler2DMS,            17)
   ENUM_VALUE(Sampler2DMSArray,       18)
   ENUM_VALUE(iSampler1D,             19)
   ENUM_VALUE(iSampler2D,             20)
   ENUM_VALUE(iSampler2DRect,         21)
   ENUM_VALUE(iSampler3D,             22)
   ENUM_VALUE(iSamplerCube,           23)
   ENUM_VALUE(iSampler1DArray,        24)
   ENUM_VALUE(iSampler2DArray,        25)
   ENUM_VALUE(iSamplerCubeArray,      26)
   ENUM_VALUE(iSamplerBuffer,         27)
   ENUM_VALUE(iSampler2DMS,           29)
   ENUM_VALUE(iSampler2DMSArray,      30)
   ENUM_VALUE(uSampler1D,             31)
   ENUM_VALUE(uSampler2D,             32)
   ENUM_VALUE(uSampler2DRect,         33)
   ENUM_VALUE(uSampler3D,             34)
   ENUM_VALUE(uSamplerCube,           35)
   ENUM_VALUE(uSampler1DArray,        36)
   ENUM_VALUE(uSampler2DArray,        37)
   ENUM_VALUE(uSamplerCubeArray,      38)
   ENUM_VALUE(uSamplerBuffer,         39)
   ENUM_VALUE(uSampler2DMS,           41)
   ENUM_VALUE(uSampler2DMSArray,      42)
...
ENUM_BEG(GX2ShaderVarType, uint32_t)
   ...
   ENUM_VALUE(UInt3,             19)
   ENUM_VALUE(UInt4,             20)
   ENUM_VALUE(Matrix2x2,         21)
   ENUM_VALUE(Matrix2x3,         22)
   ENUM_VALUE(Matrix2x4,         23)
   ENUM_VALUE(Matrix3x2,         24)
   ENUM_VALUE(Matrix3x3,         25)
   ENUM_VALUE(Matrix3x4,         26)
   ENUM_VALUE(Matrix4x2,         27)
   ENUM_VALUE(Matrix4x3,         28)
